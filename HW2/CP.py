...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.DivideCP = QtGui.QRadioButton(self.CPFunc)
        self.DivideCP.setEnabled(False)
        self.DivideCP.setGeometry(QtCore.QRect(10, 50, 89, 16))
        self.DivideCP.setObjectName(_fromUtf8("DivideCP"))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.DivideCP.setText(_translate("mainWindow", "分治算法", None))
        ...
        self.HandButton.setText(_translate("mainWindow", "生成", None))
